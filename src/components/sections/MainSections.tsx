...
const ADVANTAGES = [
  {
    ...
    num: "15+",
    label: "лет опыта",
    desc: "более 15 лет работы постоянной команды мастеров",
  },
  {
    icon: "Home",
    num: "100+",
    label: "объектов",
    desc: "реализовано в Краснодаре и Анапе",
  },
  {
    icon: "Clock",
    num: "0",
    label: "штрафов",
    desc: "сдаём в срок — это условие прописано в договоре",
  },
  {
    icon: "Shield",
    num: "2 года",
    label: "гарантия",
    desc: "на все виды выполненных работ",
  },
];
